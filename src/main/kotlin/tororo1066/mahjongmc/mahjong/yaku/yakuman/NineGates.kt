...
import tororo1066.mahjongmc.mahjong.yaku.doubleYakuman.TrueNineGates
import tororo1066.mahjongmc.tile.TileType

object NineGates: AbstractYakumanWinning() {
    override val name: String = "九蓮宝燈"
    override val conflictsWith: Set<AbstractWinning> = setOf(TrueNineGates)
